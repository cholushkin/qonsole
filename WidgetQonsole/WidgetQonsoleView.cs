...
public class WidgetQonsoleView : MonoBehaviour
{
    ...
    void LogWindow()
    {
        ...
        if (ImGui.BeginChild("ScrollRegion##", new Vector2(0, -footerHeightToReserve), false, 0))
        {
            ...
            // Display items.
            foreach (var item in m_ConsoleSystem.CircList)
...
//            foreach (var item in m_ConsoleSystem.Items())
    ...
    void InputBar()
    {
        ...
        if (ImGui.InputText("Input", ref bufferStr, 32, inputTextFlags))
        {
            print(bufferStr);
            //m_ConsoleSystem.Items().Add(bufferStr);
            //m_ConsoleSystem.Items().Add("1111111111111111111111111111 11111111111111111111111111111111111111111 111111111111111111111111111111111111");
            //m_ConsoleSystem.Items().Add("2222222222222222222222222222222222222 2222222222222222222222222222222222222222222 22222222222222222222222222222222");
            //m_ConsoleSystem.Items().Add("1111111111111111111111111111 11111111111111111111111111111111111111111 111111111111111111111111111111111111");
            //m_ConsoleSystem.Items().Add("2222222222222222222222222222222222222 2222222222222222222222222222222222222222222 22222222222222222222222222222222");
            //m_ConsoleSystem.Items().Add("1111111111111111111111111111 11111111111111111111111111111111111111111 111111111111111111111111111111111111");
            //m_ConsoleSystem.Items().Add("2222222222222222222222222222222222222 2222222222222222222222222222222222222222222 22222222222222222222222222222222");
            ...
            m_ConsoleSystem.CircList.Enqueue(bufferStr);
            m_ConsoleSystem.CircList.Enqueue("1111111111111111111111111111 11111111111111111111111111111111111111111 111111111111111111111111111111111111");
            m_ConsoleSystem.CircList.Enqueue("2222222222222222222222222222222222222 2222222222222222222222222222222222222222222 22222222222222222222222222222222");
            m_ConsoleSystem.CircList.Enqueue("1111111111111111111111111111 11111111111111111111111111111111111111111 111111111111111111111111111111111111");
            m_ConsoleSystem.CircList.Enqueue("2222222222222222222222222222222222222 2222222222222222222222222222222222222222222 22222222222222222222222222222222");
            m_ConsoleSystem.CircList.Enqueue("1111111111111111111111111111 11111111111111111111111111111111111111111 111111111111111111111111111111111111");
            m_ConsoleSystem.CircList.Enqueue("2222222222222222222222222222222222222 2222222222222222222222222222222222222222222 22222222222222222222222222222222");
        ...
        //if (ImGui.InputText("Input", buffer, 32,inputTextFlags, InputCallback, IntPtr.Zero))
        //{
        //    print("enter");
        //    //// Validate.
        //    //if (!m_Buffer.empty())
